...
import 'package:clean_arch_resocoder/features/number_trivia/domain/usecases/get_concrete_number_trivia.dart';
...
void main() {
  ...
  test('Deve receber o trivia a partir do numero mandado ao repositorio',
      () async {
